                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn px-2 py-1" data-bs-toggle="modal" data-bs-target="#editing_{{$user->id}}">
                                            ...
                                            <button type="button" class="btn px-2 py-1" data-bs-toggle="modal" data-bs-target="#deleting_{{$user->id}}">
