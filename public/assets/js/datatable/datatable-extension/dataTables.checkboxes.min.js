	...
	(x.prototype = {
        _constructor: function () {
            for (
                ...
                i.aoColumns[r].checkboxes &&
                    ...
                    (h = !0),
                    k.isPlainObject(i.aoColumns[r].checkboxes) ||
                        (i.aoColumns[r].checkboxes = {}),
                    (i.aoColumns[r].checkboxes = k.extend(
                        {},
                        x.defaults,
                        i.aoColumns[r].checkboxes
                    )),
                    ...
                    "" === i.aoColumns[r].sClass
                        ...
                        : (t.className =
                              i.aoColumns[r].sClass + " dt-checkboxes-cell"),
                    ...
                    e.off(".dt"),
                    null === i.sAjaxSource &&
                        ((c = d.cells("tr", r)).invalidate("data"),
                        k(c.nodes()).addClass(t.className)),
                    (n.s.data[r] = {}),
                    (n.s.dataDisabled[r] = {}),
                    n.s.columns.push(r),
                    i.aoColumns[r].checkboxes.selectRow &&
                        (i._select
                            ? (u = !0)
                            : (i.aoColumns[r].checkboxes.selectRow = !1)),
                    i.aoColumns[r].checkboxes.selectAll &&
                        (e.data("html", e.html()),
                        null !== i.aoColumns[r].checkboxes.selectAllRender &&
                            ((s = ""),
                            k.isFunction(
                                i.aoColumns[r].checkboxes.selectAllRender
                            )
                                ? (s =
                                      i.aoColumns[
                                          r
                                ...
                                : "string" ==
                                      typeof i.aoColumns[r].checkboxes
                                          .selectAllRender &&
                                  (s =
                                      i.aoColumns[r].checkboxes
                                          .selectAllRender),
        ...
        updateStateCheckboxes: function (e) {
            ...
            t.cells("tr", o.s.columns, e).every(function (e, t) {
                ...
                l.checkboxes.s.data[t].hasOwnProperty(c) &&
                    ...
                    l.aoColumns[t].checkboxes.selectRow &&
                        s &&
                        o.updateSelect(e, !0)),
                    s ||
                        k("input.dt-checkboxes", this.node()).prop(
                            "disabled",
                            !0
                        );
            });
        ...
        onClick: function (e, c) {
            ...
            o.aoColumns[d].checkboxes.selectRow
                ? setTimeout(function () {
                      ...
                      t !== c.checked &&
                          (s.updateCheckbox(n, d, t), s.updateSelectAll(d));
                  }, 0)
        ...
        updateSelectAll: function (c) {
            ...
            x.aoColumns[c].checkboxes &&
                ...
                ((e = b.cells("tr", c, {
                    page: x.aoColumns[c].checkboxes.selectAllPages
                        ? "all"
                        : "current",
                    search: "applied",
                })),
                ...
                k.each(a, function (e, t) {
                    r.isCellSelectable(c, t)
                        ? r.s.data[c].hasOwnProperty(t) && o++
                        : l++;
                }),
                x._fixedHeader &&
        ...
        (x.defaults = {
            ...
            selectAllRender:
                '<input type="checkbox" class="checkbox_animated" autocomplete="off" id="selectAll">',
        });
						...
						function (e, t, c) {
							...
							e.aoColumns[c].checkboxes &&
								...
								e.checkboxes.isCellSelectable(c, o) &&
									...
									e.aoColumns[c].checkboxes
										.selectRow &&
										e.checkboxes.updateSelect(
											t,
											l,
										),
									e.checkboxes.updateSelectAll(c),
									e.checkboxes.updateFixedColumn(
										c,
									)));
						},
						1,
					...
					this.iterator(
						...
						function (e, t, c) {
							...
							e.aoColumns[c].checkboxes &&
								...
								a
									? delete e.checkboxes.s
											.dataDisabled[c][o]
									: (e.checkboxes.s.dataDisabled[c][
											o
									  ] = 1),
								(l = s.node()) &&
									k('input.dt-checkboxes', l).prop(
										'disabled',
										!a,
									),
								e.aoColumns[c].checkboxes.selectRow &&
